    ...
    <>
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 pt-16 pb-24 lg:px-10 lg:pt-24">
          ...
          <h1 className="mt-8 font-serif text-[14vw] leading-[0.9] tracking-tight md:text-[8.5rem] lg:text-[10rem]">
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
        <div className="grid gap-6 lg:grid-cols-12">
          <div className="relative col-span-full overflow-hidden rounded-3xl bg-brand-coral p-8 text-background sm:p-12 lg:col-span-7 lg:row-span-2">
            ...
            <Link
              href="/about"
              className="mt-10 inline-flex items-center gap-2 text-sm underline-offset-4 hover:underline"
            >
              Read our manifesto
              <ArrowUpRight className="h-4 w-4" />
            </Link>
          ...
          <div className="col-span-full overflow-hidden rounded-3xl bg-brand-cyan/30 p-8 lg:col-span-5">
            ...
            <ul className="mt-6 space-y-4 font-serif text-2xl">
              <li className="flex items-baseline justify-between border-b border-foreground/15 pb-3">
          ...
          <div className="col-span-full overflow-hidden rounded-3xl bg-brand-yellow/40 p-8 lg:col-span-5">
            <p className="font-mono text-xs uppercase tracking-widest text-foreground/70">
              [ By the numbers ]
            </p>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 lg:px-10">
        <div className="flex items-end justify-between">
          ...
          <Link
            href="/projects"
            className="hidden items-center gap-2 rounded-full border border-border bg-card px-5 py-2.5 text-sm transition-colors hover:bg-secondary md:inline-flex"
          >
            All projects
            <ArrowUpRight className="h-4 w-4" />
          </Link>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {featured.map((p) => (
            ...
            >
              <div className={`relative aspect-[4/5] overflow-hidden rounded-3xl ${p.color}`}>
                <Image
                  src={p.image}
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 lg:px-10">
        ...
        <div className="mt-6 grid grid-cols-2 gap-x-10 gap-y-6 border-y border-border/60 py-10 sm:grid-cols-3 md:grid-cols-6">
          {["Finch", "Mossy", "Orbit", "Atlas", "Nimbus", "Halo"].map((name) => (
            <div
              key={name}
